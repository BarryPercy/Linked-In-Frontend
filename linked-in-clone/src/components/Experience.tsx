      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
            <Form>
                ...
                <Form.Control type="text" placeholder="Ex: Full-Stack Developer" />
                {/* <Form.Label>Employment Type*</Form.Label>
                <Form.Control as="select">
                    <option value="Full-Time">Full-Time<
                </Form.Control> */}
                <Form.Label>Company name*</Form.Label>
                <Form.Control type="text" placeholder="Ex: Epicode" />
                ...
                <Form.Label>Skills &#40;We recommend adding your top 5 used in this role. They'll also appear in your Skills section.&#41;</Form.Label>
            </Form>
