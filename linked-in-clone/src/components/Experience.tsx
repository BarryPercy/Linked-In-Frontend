...
const Experience = ()=>{
    ...
    let array:Experience[] =[{
        ...
        "__v": 0,  																
        "image": "https://media.licdn.com/dms/image/C4D0BAQEFWO_s8a0FHQ/company-logo_100_100/0/1647618816994?e=1684972800&v=beta&t=TPNYWQvNS5llJxWVNsaOC9JuymAFPxR8tOSYYjqu8Q4",
    }]
            ...
            <Card>
                <Card.Body>
                    ...
                    <Card.Title><h4>Experience</h4></Card.Title>
                            {array.map((experience:Experience)=>{
                                return(
                                        <div key={experience._id} className="d-flex">
                                            <Image src={experience.image} className="align-self-start"/>
                                                <div className="d-flex flex-column">
                                                    ...
                                                    <h6 className="grey-text">{experience.startDate} - {experience.endDate}</h6>
